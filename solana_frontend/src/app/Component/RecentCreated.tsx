...
export default function RecentCreated() {
  return (
    <div className="lg:max-w-[1400px] 2xl:max-w-[1560px] md:max-w-[1200px] sm:max-w-[1020px] mt-6 mx-auto px-4 2xl:px-12 lg:px-8 pb-8">
      <h2 className="text-[#ffffff] text-[32px] font-[700] mb-6">Recent Created</h2>
